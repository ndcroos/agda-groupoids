...
module Groupoids.Ambient.Type.Discrete where

open import Agda.Primitive
import Groupoids.Ambient.Type.Map.Boot as Map
open import Groupoids.Ambient.Type.Tensor as Ten
  using (_,_)
import Groupoids.Ambient.Type.Terminal as 𝟙
